 ...
 * ```
 */
export declare function tinykeys(target: Window | HTMLElement, keyBindingMap: KeyBindingMap, options?: KeyBindingOptions): Unsubscribe;
export {};
//# sourceMappingURL=tinykeys.d.ts.map