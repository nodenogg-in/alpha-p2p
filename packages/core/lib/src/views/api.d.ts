...
import { Node, Node_ID } from '@nodenogg.in/schema';
...
export type ViewFactory<API extends MicrocosmAPI = MicrocosmAPI, V extends View = View> = (api: API, config: ViewConfig) => Promise<V>;
