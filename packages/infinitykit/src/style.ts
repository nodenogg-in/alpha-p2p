...
import type { Box, CanvasState, Transform } from '.'
...
export const scale = (scale: Transform['scale']) => `matrix(${scale}, 0, 0, ${scale}, 0, 0)`

export const translate = (translate: Transform['translate']) =>
