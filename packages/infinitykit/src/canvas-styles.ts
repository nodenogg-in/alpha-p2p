...
const canvasStyle = `position: absolute; width: 100%; height: 100%; top: 0px; left: 0px; transform-origin: 50% 50%; transform: var(--${TRANSFORM_NAME}); pointer-events: none;`

export const getCanvasStyles = (canvas: CanvasState) => ({
