...
export const set = (v: Vector2, a: Vector2) => {
  v[0] = a[0]
  v[1] = a[1]
  return v
}

export const vector2 = (initial: Vector2 = [0, 0]): Vector2 => set(new Float32Array(2), initial)

export const clone = (v: Vector2) => vector2([v[0], v[1]])

export const copy = (v: Vector2, a: Vector2) => set(v, a)

export const reset = (v: Vector2) => {
  v[0] = 0
  v[1] = 0
  return v
}
