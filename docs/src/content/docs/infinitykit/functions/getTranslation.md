...
[packages/infinitykit/src/utils/interaction.ts:26](https://github.com/nodenogg-in/alpha-p2p/blob/3fa520d/packages/infinitykit/src/utils/interaction.ts#L26)
