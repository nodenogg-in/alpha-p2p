...
[packages/infinitykit/src/utils/interaction.ts:26](https://github.com/nodenogg-in/alpha-p2p/blob/f9f51d2/packages/infinitykit/src/utils/interaction.ts#L26)
