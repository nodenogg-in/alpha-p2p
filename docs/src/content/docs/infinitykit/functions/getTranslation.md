...
[packages/infinitykit/src/utils/interaction.ts:26](https://github.com/nodenogg-in/alpha-p2p/blob/e7369be/packages/infinitykit/src/utils/interaction.ts#L26)
