...
[packages/infinitykit/src/CanvasInteraction.ts:56](https://github.com/nodenogg-in/alpha-p2p/blob/439030a/packages/infinitykit/src/CanvasInteraction.ts#L56)
