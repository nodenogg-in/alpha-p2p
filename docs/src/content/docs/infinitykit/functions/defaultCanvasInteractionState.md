...
[packages/infinitykit/src/CanvasInteraction.ts:56](https://github.com/nodenogg-in/alpha-p2p/blob/3fa520d/packages/infinitykit/src/CanvasInteraction.ts#L56)
