...
[packages/infinitykit/src/CanvasInteraction.ts:56](https://github.com/nodenogg-in/alpha-p2p/blob/1d822c8/packages/infinitykit/src/CanvasInteraction.ts#L56)
