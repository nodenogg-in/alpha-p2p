...
[packages/infinitykit/src/utils/interaction.ts:39](https://github.com/nodenogg-in/alpha-p2p/blob/f9f51d2/packages/infinitykit/src/utils/interaction.ts#L39)
