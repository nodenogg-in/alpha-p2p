...
[packages/infinitykit/src/CanvasInteraction.ts:34](https://github.com/nodenogg-in/alpha-p2p/blob/c776139/packages/infinitykit/src/CanvasInteraction.ts#L34)
