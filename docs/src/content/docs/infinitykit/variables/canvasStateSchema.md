...
[packages/infinitykit/src/CanvasInteraction.ts:34](https://github.com/nodenogg-in/alpha-p2p/blob/7587666/packages/infinitykit/src/CanvasInteraction.ts#L34)
