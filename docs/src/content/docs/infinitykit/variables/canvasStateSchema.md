...
[packages/infinitykit/src/CanvasInteraction.ts:34](https://github.com/nodenogg-in/alpha-p2p/blob/f9f51d2/packages/infinitykit/src/CanvasInteraction.ts#L34)
