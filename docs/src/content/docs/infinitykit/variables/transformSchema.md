...
[packages/infinitykit/src/schema/spatial.schema.ts:46](https://github.com/nodenogg-in/alpha-p2p/blob/820565a/packages/infinitykit/src/schema/spatial.schema.ts#L46)
