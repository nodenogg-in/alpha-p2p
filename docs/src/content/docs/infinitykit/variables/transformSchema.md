...
[packages/infinitykit/src/schema/spatial.schema.ts:46](https://github.com/nodenogg-in/alpha-p2p/blob/6ade6d6/packages/infinitykit/src/schema/spatial.schema.ts#L46)
