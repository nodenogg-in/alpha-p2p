...
- [IdentityID](type-aliases/IdentityID.md)
- [IdentityWithStatus](type-aliases/IdentityWithStatus.md)
- [MicrocosmAPIConfig](type-aliases/MicrocosmAPIConfig.md)
- [MicrocosmAPIEvents](type-aliases/MicrocosmAPIEvents.md)
- [MicrocosmAPIFactory](type-aliases/MicrocosmAPIFactory.md)
- [MicrocosmID](type-aliases/MicrocosmID.md)
- [MicrocosmReference](type-aliases/MicrocosmReference.md)
- [NewNode](type-aliases/NewNode.md)
- [Node](type-aliases/Node.md)
- [NodeID](type-aliases/NodeID.md)
- [NodeMap](type-aliases/NodeMap.md)
- [NodePatch](type-aliases/NodePatch.md)
- [NodeReference](type-aliases/NodeReference.md)
- [NodeType](type-aliases/NodeType.md)
- [NodeUpdate](type-aliases/NodeUpdate.md)

## Variables

- [MAX\_CHARACTER\_COUNT](variables/MAX_CHARACTER_COUNT.md)
- [SCHEMA\_VERSION](variables/SCHEMA_VERSION.md)
- [connectionNodeSchema](variables/connectionNodeSchema.md)
- [emojiNodeSchema](variables/emojiNodeSchema.md)
- [htmlNodeSchema](variables/htmlNodeSchema.md)
- [identityID](variables/identityID.md)
- [identitySchema](variables/identitySchema.md)
- [identityStatusSchema](variables/identityStatusSchema.md)
- [microcosmID](variables/microcosmID.md)
- [microcosmReferenceSchema](variables/microcosmReferenceSchema.md)
- [nodeSchema](variables/nodeSchema.md)
...
- [isNodeReference](functions/isNodeReference.md)
- [isNodeReferenceType](functions/isNodeReferenceType.md)
