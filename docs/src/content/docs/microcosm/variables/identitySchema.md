...
[internal/microcosm/src/schema/identity.schema.ts:9](https://github.com/nodenogg-in/alpha-p2p/blob/3fa520d/internal/microcosm/src/schema/identity.schema.ts#L9)
