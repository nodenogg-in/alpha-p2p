...
[internal/microcosm/src/schema/identity.schema.ts:9](https://github.com/nodenogg-in/alpha-p2p/blob/f9f51d2/internal/microcosm/src/schema/identity.schema.ts#L9)
