...
- [EditableAPI](interfaces/EditableAPI.md)
...
- [BACKGROUND\_GRID\_UNIT](variables/BACKGROUND_GRID_UNIT.md)
- [DEFAULT\_BOUNDS](variables/DEFAULT_BOUNDS.md)
- [DEFAULT\_BOX\_SIZE](variables/DEFAULT_BOX_SIZE.md)
- [DEFAULT\_CARD\_OUTLINE](variables/DEFAULT_CARD_OUTLINE.md)
- [DEFAULT\_PATTERN](variables/DEFAULT_PATTERN.md)
- [DEFAULT\_SNAP\_TO\_GRID](variables/DEFAULT_SNAP_TO_GRID.md)
- [DEFAULT\_TOOL](variables/DEFAULT_TOOL.md)
- [INITIAL\_TRANSLATION](variables/INITIAL_TRANSLATION.md)
- [INITIAL\_ZOOM](variables/INITIAL_ZOOM.md)
- [MAX\_ZOOM](variables/MAX_ZOOM.md)
- [MINIMUM\_BOX\_SIZE](variables/MINIMUM_BOX_SIZE.md)
- [MIN\_ZOOM](variables/MIN_ZOOM.md)
- [PAN\_INCREMENT](variables/PAN_INCREMENT.md)
- [PAN\_TIME](variables/PAN_TIME.md)
