        ...
        <MenubarPortal>
          ...
          >
            ...
            <MenubarItem
              ...
              v-bind:key="`menu-link-${microcosm.microcosmID}${microcosm.view}`"
              as-child
            >
              <MenuLink
                :microcosm="microcosm"
            ...
            <MenubarItem class="menubar-item"> View all </MenubarItem>
            <MenubarCheckboxItem v-model:checked="menuOpen" class="menubar-checkbox-item">
              <MenubarItemIndicator class="menubar-item-indicator"> </MenubarItemIndicator>
              <Icon type="pin" />
              <!-- Keep open {{ menuOpen }} -->
            </MenubarCheckboxItem>
          </MenubarContent>
