...
<template>
    <ToolbarRoot class="editor-toolbar" aria-label="Formatting options" >
        ...
        <ToolbarButton as-child>
            <Button @click="editor.chain().focus().unsetLink().run()" :disabled="!editor.isActive('link')">Unset
                link</Button>
        </ToolbarButton>
...
.editor-toolbar {
    ...
    transform: translateY(calc(var(--size-8) * -1)) scale(calc(1.0 / var(--spatial-view-scale)));
