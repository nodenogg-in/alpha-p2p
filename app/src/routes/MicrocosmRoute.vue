...
<template>
  <Panel>
    <Microcosm
      navigation
      v-if="data.microcosm_uri"
      :microcosm_uri="data.microcosm_uri"
      v-bind:key="`main/${data.microcosm_uri}`"
      :id="`${data.microcosm_uri}/main`"
      ui
    />
  </Panel>
  <Panel
    ...
    :x="10"
    :y="60"
    v-for="(microcosm_uri, i) in data.subviews"
